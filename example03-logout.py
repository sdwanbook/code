...
# ================ Example 13-5 in the book begins from here
token_url = base_api_url + "/client/token?json=true"
...
if response.status_code == 200:
    ...
    print (f"Unable to obtain the authentication token")

# ================ Example 13-7 in the book begins from here
logout_url = base_url + "/logout?nocache="

# Log out
response = session.post (url = logout_url, allow_redirects = False)
check_API_status (response)
